...
<body>
	...
	<div class="form-container">
		<h3>
			<spring:message code="label.selectDestination" />
		</h3>

		<form:form modelAttribute="airinfoDto" action="/airplane/Reservation"
			method="post">

			<!-- 출발지 -->
			<div class="mb-3">
				<label for="departure" class="form-label"><spring:message
						code="label.departure" />:</label> <select name="departure" id="departure"
			...
			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				...
				<button type="button" class="btn btn-outline-secondary"
					onclick="location.href='/airplane'">
